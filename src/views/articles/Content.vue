      ...
      <div class="col-md-9 left-col pull-right">
        <div class="panel article-body content-body">
          ...
          <Modal :show.sync="showQrcode" class="text-center">
            ...
            <div>
              <p class="text-md">
                如果你想学习更多前端的知识，Learnku Vue.js.com 是个不错的开始
              </p>
              <div class="payment-qrcode inline-block">
                <h5>扫一扫打开 Learnku Vue.js.com</h5>
                <p>
                  <qrcode-vue
                    value="https://learnku.com/vuejs/"
                    :size="160"
                  ></qrcode-vue>
                </p>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div class="infos">
                    <div class="media-heading">
                      ...
                      <span v-if="auth" class="operate pull-right">
                        <span v-if="comment.uid === 1">
                          <a
                            href="javascript:;"
                            @click="editComment(comment.commentId, index)"
                    ...
                    <div
                      class="preview media-body markdown-reply markdown-body"
